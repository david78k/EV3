...
//		protected EncoderMotor right_motor;
		 ...
		 */
		private const int WAIT_TIME = 7; // originally 8
		...
		private const double KGYROANGLE = 7.5;
		private const double KGYROSPEED = 1.15;
		private const double KPOS = 0.07;
		private const double KSPEED = 0.1;

		private const double KDRIVE = -0.02;

		/**
		 * Power differential used for steering based on difference of target steering and actual motor difference.
		 */
		private const double KSTEER = 0.25;
	 ...
	 */
			private const double CONTROL_SPEED  = 600.0;
